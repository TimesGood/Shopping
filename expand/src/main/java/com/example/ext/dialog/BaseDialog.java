...
import com.example.ext.action.ActivityAction;
import com.example.ext.action.ClickAction;
import com.example.ext.action.HandlerAction;
import com.example.ext.action.KeyboardAction;
import com.example.ext.action.ResourcesAction;
import com.example.ext.enums.AnimStyle;
...
public class BaseDialog extends AppCompatDialog
    ...
    public static class Builder<B extends Builder<?>> implements
        ...
        /** 动画样式 */
        private int mAnimStyle = AnimStyle.ANIM_DEFAULT;
        /** 重心位置 */
        ...
        public BaseDialog create() {
            ...
            if (mAnimStyle == AnimStyle.ANIM_DEFAULT) {
                switch (mGravity) {
                    case Gravity.TOP:
                        mAnimStyle = AnimStyle.ANIM_TOP;
                        break;
                    case Gravity.BOTTOM:
                        mAnimStyle = AnimStyle.ANIM_BOTTOM;
                        break;
                    case Gravity.LEFT:
                        mAnimStyle = AnimStyle.ANIM_LEFT;
                        break;
                    case Gravity.RIGHT:
                        mAnimStyle = AnimStyle.ANIM_RIGHT;
                        break;
                    default:
                        mAnimStyle = AnimStyle.ANIM_DEFAULT;
                        break;
                }
            }
    ...
    private static final class DialogLifecycle implements
        ...
        public void onActivityPaused(@NonNull Activity activity) {
            ...
            if (mDialog != null && mDialog.isShowing()) {
                ...
                // 设置 Dialog 无动画效果
                mDialog.setWindowAnimations(AnimStyle.ANIM_EMPTY);
            }
        }
